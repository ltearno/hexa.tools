...
public class ServiceGenerator extends Generator
{
	...
	throws UnableToCompleteException
	{
		...
		sw.println( "public void Init( String baseUrl, ServerCommMessageCb serverCommMessageCb, Service service, ITablesManager tablesMng )" );
		sw.println( "{" );
		sw.println( "    setConfig( \""+interfaceChecksum+"\" );" );
		sw.println( "    initFactories();" );
		sw.println( "    srv.Init( baseUrl, serverCommMessageCb, service, tablesMng, this );" );
		sw.println( "}" );
		sw.println();
