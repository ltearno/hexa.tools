 ...
 * the default HexaCss naming convention for a specific method.<br/>
 * This allows to use existing CSS stylesheets.<br/>
...
public @interface HexaCssExtra
{
	 ...
	 * the CSS class name will be forced to the value of this field.<br/>
