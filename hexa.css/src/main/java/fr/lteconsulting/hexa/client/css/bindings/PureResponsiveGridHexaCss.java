...
/**
 * HexaCss wrapper for the CSS classes defined in the 'grids-responsive-min.css'
...
public interface PureResponsiveGridHexaCss extends HexaCss {
    public static final PureResponsiveGridHexaCss GRID = GWT.create(PureResponsiveGridHexaCss.class);
