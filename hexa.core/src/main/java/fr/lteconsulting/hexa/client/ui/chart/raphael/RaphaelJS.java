...
public class RaphaelJS extends JavaScriptObject {
     ...
     *
     * @param obj string Attributes for the resulting path as described in the
     *            attr reference.
    ...
    public static class Element extends JavaScriptObject {
         ...
         *
         * @param degree     number of degrees of rotation (0-360)
         * @param isAbsolute boolean Specifies if degree is relative to previous
         ...
         *
         * @param newAttrs string Attributes of the object after animation (not all
         ...
         * string [â€œâ€�, â€œ-â€�, â€œ.â€�, â€œ-.â€�,
         * â€œ-..â€�, â€œ. â€�, â€œ- â€�, â€œ--â€�, â€œ- .â€�,
         * â€œ--.â€�, â€œ--..â€�] . stroke-linecap string
         * [â€œbuttâ€�, â€œsquareâ€�, â€œroundâ€�] .
         * stroke-linejoin string [â€œbevelâ€�, â€œroundâ€�,
         * â€œmiterâ€�] . stroke-miterlimit number .
