...
public class GenericJSO extends JavaScriptObject {
    ...
    public final native <T extends JavaScriptObject> void setObject(String key, T value) /*-{
        this[key] = value;
    }-*/;
    ...
    public final native int getIntByIdx(int idx) /*-{
        var v = 1 * this[idx];
        if (isNaN(v)) v = -1;
        return v;
    }-*/;

    public final native double getDoubleByIdx(int idx) /*-{
        var v = 1.0 * (Math.round(100.0 * this[idx]) / 100.0);
        if (isNaN(v)) v = -12567.0;
        return v;
    }-*/;

    public final native String getStringByIdx(int idx) /*-{
        return "" + this[idx];
    }-*/;

    public final native <T extends JavaScriptObject> T getJavaScriptObjectByIdx(int idx) /*-{
        return this[idx];
    }-*/;

    public final native GenericJSO getGenericJSO(String fieldName) /*-{
        return this[fieldName] || null;
    }-*/;

    public final native GenericJSO getGenericJSOByIdx(int idx) /*-{
        return this[idx];
    }-*/;
    ...
    public final native void setDouble(String fieldName, double value) /*-{
        this[fieldName] = value;
    }-*/;

    public final native double getDouble(String fieldName) /*-{
        return 1.0 * (Math.round(100.0 * this[fieldName]) / 100.0);
    }-*/;

    public final native String getString(String fieldName) /*-{
        return "" + this[fieldName];
    }-*/;

    public final native boolean getBoolean(String fieldName) /*-{
        return this[fieldName] > 0 ? true : false;
    }-*/;

    public final native <T extends JavaScriptObject> JsArray<T> getArray(String fieldName) /*-{
        return this[fieldName];
    }-*/;

    public final native <T extends JavaScriptObject> JsArray<T> getArrayByIdx(int idx) /*-{
        return this[idx];
    }-*/;

    public final native JsArrayInteger getArrayOfInt(String fieldName) /*-{
        return this[fieldName];
    }-*/;

    public final native JsArrayString getArrayOfString(String fieldName) /*-{
        return this[fieldName];
    }-*/;
