...
@SupportedAnnotationTypes({ AngularComponentProcessor.DirectiveAnnotationFqn,
		AngularComponentProcessor.ComponentAnnotationFqn, AngularComponentProcessor.InjectableAnnotationFqn,
...
public class AngularComponentProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		// JSNIOutputProcessor processor = new JSNIOutputProcessor(
		// processingEnv );
