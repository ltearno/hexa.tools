...
public class File extends JavaScriptObject
{
	...
	public final native String getFileName() /*-{ return this.name; }-*/; // || this.fileName; }-*/;
	...
	/*-{
		...
		{
			callback.@com.hexa.client.uploadjs.File.Callback::onDataReady(Ljava/lang/String;)( event.target.result );
		};
	...
	/*-{
		...
		reader.onload = function( event )
		{
			callback.@com.hexa.client.uploadjs.File.CallbackArrayBuffer::onDataReady(Lcom/google/gwt/typedarrays/shared/ArrayBuffer;)( event.target.result );
		};
