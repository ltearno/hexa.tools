...
public class XMLHttpRequestEx extends JavaScriptObject
{
	...
	/*
	 * NOTE: Testing discovered that for some bizarre reason, on Mozilla, the JavaScript <code>XmlHttpRequest.onreadystatechange</code> handler function maybe
	 * still be called after it is deleted. The theory is that the callback is cached somewhere. Setting it to null or an empty function does seem to work
	 * properly, though.
	 * 
	 * On IE, there are two problems: Setting onreadystatechange to null (as opposed to an empty function) sometimes throws an exception. With particular (rare)
	 * versions of jscript.dll, setting onreadystatechange from within onreadystatechange causes a crash. Setting it from within a timeout fixes this bug (see
	 * issue 1610).
	 * 
	 * End result: *always* set onreadystatechange to an empty function (never to null). Never set onreadystatechange from within onreadystatechange (always in
	 * a setTimeout()).
	 */
	...
	/**
	 * The OPENED state is the state of the object when the open() method has been successfully invoked. During this state request headers can be set using
	...
	/**
	 * The DONE state is the state of the object when either the data transfer has been completed or something went wrong during the transfer (infinite
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#abort" >http://www.w3.org/TR/XMLHttpRequest/#abort</a>.
	 */
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#onreadystatechange" >http://www.w3.org/TR/XMLHttpRequest/#onreadystatechange</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#getallresponseheaders" >http://www.w3.org/TR/XMLHttpRequest/#getallresponseheaders</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#readystate" >http://www.w3.org/TR/XMLHttpRequest/#readystate</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#getresponseheader" >http://www.w3.org/TR/XMLHttpRequest/#getresponseheader</a>.
	 * 
	 * @param header
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#responsetext" >http://www.w3.org/TR/XMLHttpRequest/#responsetext</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#status" >http://www.w3.org/TR/XMLHttpRequest/#status</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#statustext" >http://www.w3.org/TR/XMLHttpRequest/#statustext</a>.
	 * 
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#open" >http://www.w3.org/TR/XMLHttpRequest/#open</a>.
	 * 
	 * @param httpMethod
	...
	/**
	 * Initiates a request with no request data. This simply calls {@link #send(String)} with <code>null</code> as an argument, because the no-argument
	 * <code>send()</code> method is unavailable on Firefox.
	 */
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#send" >http://www.w3.org/TR/XMLHttpRequest/#send</a>.
	 * 
	 * @param requestData
	...
	/*-{
		...
		upload.addEventListener( "progress", function( event ) {
			if (event.lengthComputable)
			{
				...
				if (percentage < 100)
					callback.@com.hexa.client.uploadjs.XMLHttpRequestEx.Callback::onProgress(I)( percentage );
			}
		}, false );
	 ...
	 * 
	 * <p>
	 * Note: Applications <em>must</em> call {@link #clearOnReadyStateChange()} when they no longer need this object, to ensure that it is cleaned up properly.
	 * Failure to do so will result in memory leaks on some browsers.
	 * </p>
	 * 
	 * @param handler
	...
	public final native void setOnReadyStateChange( ReadyStateChangeHandler handler ) /*-{
																						...
																						handler.@com.hexa.client.uploadjs.XMLHttpRequestEx.ReadyStateChangeHandler::onReadyStateChange(Lcom/hexa/client/uploadjs/XMLHttpRequestEx;)( _this );
																						});
																						}-*/;
	 ...
	 * <p>
	 * See <a href="http://www.w3.org/TR/XMLHttpRequest/#setrequestheader" >http://www.w3.org/TR/XMLHttpRequest/#setrequestheader</a>.
	 * 
	 * @param header
