...
public abstract class TableServiceBase<T>
{
	...
	protected boolean isClientInterestedByRecord( T record, Object clientParam ) { return true; }
						...
						else
						{
							...
							doGetRecords( new SimpleAsyncCallback<Iterable<T>>() {
								public void onSuccess(Iterable<T> result)
								{
									...
									//GWT.log( "TableServiceBase "+logName+" WHOLE TABLE RECEIVED / " + TableServiceBase.this.toString() );
