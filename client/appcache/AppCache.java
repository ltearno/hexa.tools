...
public final class AppCache extends JavaScriptObject
{
	...
	/*-{
		handleCached = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::CACHED);
		};

		this.addEventListener('cached', handleCached, false);

		handleChecking = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::CHECKING);
		};

		this.addEventListener('checking', handleChecking, false);

		handleDownloading = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::DOWNLOADING);
		};

		this.addEventListener('downloading', handleDownloading, false);

		handleError = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::ERROR);
		};

		this.addEventListener('error', handleError, false);

		handleNoUpdate = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::NOUPDATE);
		};

		this.addEventListener('noupdate', handleNoUpdate, false);

		handleObsolete = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::OBSOLETE);
		};

		this.addEventListener('obsolete', handleObsolete, false);

		handleProgress = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::PROGRESS);
		};

		this.addEventListener('progress', handleProgress, false);

		handleUpdateReady = function(s) {
			callback.@com.hexa.client.appcache.AppCache.Callback::handleAppCacheEvent(Lcom/hexa/client/appcache/AppCacheEvent;)(@com.hexa.client.appcache.AppCacheEvent::UPDATEREADY);
		};
