...
{
	@Override
	public void addCallback( Callback<T> callback, Object cookie ) // throws Exception
	{
		assert( this.callback == null );
		//if( this.callback != null )
		//	throw new Exception( "AValueControl::addCallback has been called but a callback was already set !" );
