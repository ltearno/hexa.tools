...
public class CachedServerComm implements ServerCommCb
{
	...
	public void Init( String baseUrl, ServerCommMessageCb serverCommMessageCb, Service service, ITablesManager tablesMng, ServiceBase serviceBase )
	{
		this.tablesMng = tablesMng;
		srv.Init( baseUrl, serverCommMessageCb, service, serviceBase );
	}
