...
public class ServerComm
{
	...
	public void Init( String baseUrl, ServerCommMessageCb serverCommMessageCb, Service service, ServiceBase serviceBase )
	{
	...
	private void sendTimerEvent()
	{
		...
		networkRqInfo.send( baseUrl, serviceBase.globalRequestPayloadAdders, serviceBase.globalRequestCallAdders );
	}
	...
	XNetworkPendingRequestInfo rqCallback = new XNetworkPendingRequestInfo()
	{
		...
		public void error( ErrorCodes errorCode, Exception exception, NetworkPendingRequestInfo request )
		{
			...
			case ERROR_REQUEST_RESPONSE_STATUS:
				...
				request.resend( serviceBase.globalRequestPayloadAdders, serviceBase.globalRequestCallAdders );
				break;
