...
import com.hexa.client.comm.RPCBatchRequestSender.XRPCBatchRequestSender;
...
public class RPCProxy
{
	...
	// can provide the missing information, then, we send the hangout answer over the network
