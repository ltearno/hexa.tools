...
{
	boolean fIsLogUserWithSession = false;
	...
	public RequestCallInfo( RequestDesc request, boolean fIsLogUserWithSession )
	{
		this.request = request;
		this.fIsLogUserWithSession = fIsLogUserWithSession;
	}
