...
public class JQuery
{
	...
	{
		// don't know why, highlighting from TreeTableBase::newItem throws an exception 
		// on Safari and Chrome when editing a Pricing Scheme (PricingSchemeEditor::schemeTable)
		try { jqEffectImpl( effect, ms, e, callback ); } catch( Exception exception ) {}
	}
