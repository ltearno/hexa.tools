package com.hexa.client.tools.imagepreloader;
...
public class ImagePreLoader
{
	...
	/*-{
		$wnd.preloadImageScript(url, function() {
			callback.@com.hexa.client.tools.imagepreloader.ImagePreLoader.Callback::onLoaded()();
		}, function() {
			callback.@com.hexa.client.tools.imagepreloader.ImagePreLoader.Callback::onError()();
		});
	}-*/;
}
