...
public class JQDatepicker extends Widget
{
	...
	/*-{
		$wnd.$( e ).datepicker( "option", "onSelect", function(dateText, inst) { datePicker.@com.hexa.client.ui.widget.JQDatepicker.Callback::onDateSelected(Ljava/lang/String;)(dateText); } );
		$wnd.$( e ).datepicker( "option", "onClose", function(dateText, inst) { datePicker.@com.hexa.client.ui.widget.JQDatepicker.Callback::onDateSelected(Ljava/lang/String;)(dateText); } );
	}-*/;
