...
public class XMLHttpRequestEx extends JavaScriptObject
{
	...
	/*-{
		...
		upload.addEventListener( "progress", function( event ) {
			if (event.lengthComputable)
			{
				...
				if (percentage < 100)
					callback.@com.hexa.client.ui.uploadjs.XMLHttpRequestEx.Callback::onProgress(I)( percentage );
			}
		}, false );
	...
	public final native void setOnReadyStateChange( ReadyStateChangeHandler handler ) /*-{
																						...
																						handler.@com.hexa.client.ui.uploadjs.XMLHttpRequestEx.ReadyStateChangeHandler::onReadyStateChange(Lcom/hexa/client/ui/uploadjs/XMLHttpRequestEx;)( _this );
																						});
																						}-*/;
