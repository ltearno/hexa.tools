...
public class Labels {
	...
	// list of the text shape we actually have in the layer, to reuse them is possible
	ArrayList<Text> existingPaths = new ArrayList<Text>();
	
	// current updating shapes working task, to be cancelled if another is to be created
