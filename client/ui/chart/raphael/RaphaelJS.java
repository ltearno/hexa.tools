...
public class RaphaelJS extends JavaScriptObject {
  ...
  public static class Element extends JavaScriptObject {
     ...
     *   . src string (URL)
     *   . stroke colour
     *   . stroke-dasharray string [â€œâ€�, â€œ-â€�, â€œ.â€�, â€œ-.â€�, â€œ-..â€�, â€œ. â€�, â€œ- â€�, â€œ--â€�, â€œ- .â€�, â€œ--.â€�, â€œ--..â€�]
     *   . stroke-linecap string [â€œbuttâ€�, â€œsquareâ€�, â€œroundâ€�]
     *   . stroke-linejoin string [â€œbevelâ€�, â€œroundâ€�, â€œmiterâ€�]
  ...
  /**
   * Added by saurabh tripathi 21/7/2011
   * There is an inconvenient rendering bug is Safari (WebKit):
