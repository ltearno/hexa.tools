...
public class ImageTextButton extends Widget implements ClickHandler, HasClickHandlers
{
	...
	public ImageTextButton( ImageResource resource, String title )
	{
		...
		//button.setAttribute( "style", "min-height:"+(resource.getHeight()+2)+"px;"+"padding-left:"+resource.getWidth()+"px; background: url('"+resource.getURL()+"') no-repeat 0px center;" );
	...
	public void setText( String text )
	{
		...
		String elem = "<img src='" + resource.getURL() + "' style='width:"+width+"px; height:"+height+"px; position:relative; margin-right:2px;'/>";
...
public class ImageTextButton extends Composite implements ClickHandler
{
	...
	{
		return "<button class='ImageTextButtonV2' style=\"padding-left:"+resource.getWidth()+"px; background: url('"+resource.getURL()+"') no-repeat 0px center;\">"+title+"</button>";
	}
	...
	@UiConstructor public ImageTextButton( ImageResource resource, String title )
	{
		...
		button.setClassName( "ImageTextButtonV2" );
		button.setAttribute( "style", "padding-left:"+resource.getWidth()+"px; background: url('"+resource.getURL()+"') no-repeat 0px center;" );
	}
