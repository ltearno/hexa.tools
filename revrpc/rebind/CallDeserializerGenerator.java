package com.hexa.revrpc.rebind;
...
public class CallDeserializerGenerator extends Generator
{
	...
	/*private void generateGetMethods( SourceWriter sourceWriter )
	{
		// check what are the methods of "typeName"
		...
		sourceWriter.println("{");
			...
			sourceWriter.println("_methods = new ArrayList<String>();");
			for( int i=0; i< methods.length; i++ )
			{
				sourceWriter.println("_methods.add( \""+methods[i].getName()+"\" );");
			}
			sourceWriter.outdent();
			sourceWriter.println("return _methods;");
		sourceWriter.println("}");
	}*/
}
